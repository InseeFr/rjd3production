...
#> The outliers table will be written at  /tmp/RtmphLPt9i/outliers-table213168b8141e.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmphLPt9i/outliers-table213168b8141e.yaml 
...
#> The td table will be written at  /tmp/RtmphLPt9i/td-table2131573f5197.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmphLPt9i/td-table2131573f5197.yaml 
