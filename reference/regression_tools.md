...
#> The outliers table will be written at  /tmp/Rtmp6Qpp6i/outliers-table1fde519d72d0.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmp6Qpp6i/outliers-table1fde519d72d0.yaml 
...
#> The td table will be written at /tmp/Rtmp6Qpp6i/td-table1fde5edbadc3.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmp6Qpp6i/td-table1fde5edbadc3.yaml 
