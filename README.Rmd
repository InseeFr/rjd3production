...
[![GH Pages built](https://github.com/InseeFr/rjd3production/actions/workflows/pkgdown.yaml/badge.svg)](https://github.com/InseeFr/rjd3production/actions/workflows/pkgdown.yaml)
<!-- badges: end -->
...
Pour plus de précisions sur la production de séries CVS-CJO vous pouvez consulter [ces pages](https://saproductionwithjdemetraandr.netlify.app/).

## Installation

**{rjd3production}** s'appuie sur le package [**{rJava}**](https://cran.r-project.org/web/packages/rJava/index.html) 

L'exécution des packages rjd3 nécessite **Java 17 ou plus**. La manière de mettre en place une telle configuration dans R est expliquée [ici](https://jdemetra-new-documentation.netlify.app/#Rconfig).
